...
public class BootstrapData implements CommandLineRunner {
    ...
    private void loadUserPersonTreatmentsData(){
        Treatment t1 = Treatment.builder()
                ...
                .price(150)
                .pictureUrl("assets/images/treatments/BridalMakeup.jpeg")
                .build();
        Treatment t2 = Treatment.builder()
                ...
                .price(75)
                .pictureUrl("assets/images/treatments/FullFaceMakeup.jpeg")
                .build();
        Treatment t3 = Treatment.builder()
                ...
                .estimatedDuration(60)
                .price(100)
                .pictureUrl("assets/images/treatments/MakeupLesson.jpeg")
                .build();
        Treatment t4 = Treatment.builder()
                ...
                .price(50)
                .pictureUrl("assets/images/treatments/AirbrushMakeup.jpeg")
                .build();
        Treatment t5 = Treatment.builder()
                ...
                .estimatedDuration(120)
                .price(150)
                .pictureUrl("assets/images/treatments/PromOrSpecialEventMakeup.jpeg")
                .build();
        Treatment t6 = Treatment.builder()
                ...
                .estimatedDuration(30)
                .price(50)
                .pictureUrl("assets/images/treatments/ContouringAndHighlighting.jpeg")
                .build();
        Treatment t7 = Treatment.builder()
                ...
                .estimatedDuration(30)
                .price(35)
                .pictureUrl("assets/images/treatments/EyelashExtensions.jpeg")
                .build();
        Treatment t8 = Treatment.builder()
                ...
                .estimatedDuration(60)
                .price(75)
                .pictureUrl("assets/images/treatments/SpecialEffectsMakeup.jpeg")
                .build();
        Treatment t9 = Treatment.builder()
                ...
                .price(50)
                .pictureUrl("assets/images/treatments/EyebrowShaping.jpeg")
                .build();
        Treatment t10 = Treatment.builder()
                ...
                .estimatedDuration(60)
                .price(125)
                .pictureUrl("assets/images/treatments/PhotoShootMakeup.jpeg")
                .build();
